...
## Project Structure
    ...
    ├── alves_mortgage_team_34575  # Django project configurations
...
1. Clone this repo and `cd alves_mortgage_team_34575`
...
2. Clone this repo and `cd alves_mortgage_team_34575`
